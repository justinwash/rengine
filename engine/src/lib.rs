...
pub use scene::{
    ...
    NodeHandle2D, Prefab2D, Prefab2DDef, PrefabSprite2D, PrefabSprite2DDef, Scene, Scene2D,
    Scene2DDef, SceneInstance2D, SceneInstance2DDef, SceneIssueSeverity, SceneLayer2D,
