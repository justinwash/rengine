...
/// Demonstrates the engine's built-in seeded RNG.
///
/// Shows:
/// - Deterministic seeded sequences
/// - engine.rng() for game-state randomness
/// - Dice rolls, weighted picks, shuffles, normal distribution
/// - Random Vec2 positions and directions
/// - Forking independent sub-RNGs
...
impl Game for RngDemo {
    ...
    fn render(&mut self, engine: &Engine, frame: &mut Frame) {
        ...
        canvas.text(20.0, 20.0, "Rng Feature Demo", 28.0, Color::WHITE, (sw, sh), atlas);
        canvas.text(
            20.0, 52.0,
        ...
        for line in &self.results {
            canvas.text(20.0, y, line, 16.0, Color::from_rgba8(200, 220, 255, 255), (sw, sh), atlas);
            y += 22.0;
        }

        canvas.text(20.0, y + 20.0, "ESC to quit", 14.0, Color::from_rgba8(120, 120, 120, 255), (sw, sh), atlas);
    }
