...
const INSPECTOR_BUTTON_TEXT_ID: usize = 125;
const INSPECTOR_BUTTON_MARKER_ID: usize = 126;
const INSPECTOR_BUTTON_BAR_COLOR_ID: usize = 127;
const INSPECTOR_BUTTON_BAR_HOVER_ID: usize = 128;
